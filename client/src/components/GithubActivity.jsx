...
export default function GithubActivity({authenticatedUsername}) {
  ...
  const githubactivityStatsUrl = `https://github-readme-streak-stats.herokuapp.com/?user=${authenticatedUsername}&stroke=${strippedTheme.neutral}&background=${strippedTheme.background}&ring=${strippedTheme.primary}&fire=${strippedTheme.primary}&currStreakNum=${strippedTheme.neutral}&currStreakLabel=${strippedTheme.primary}&sideNums=${strippedTheme.neutral}&sideLabels=${strippedTheme.neutral}&dates=${strippedTheme.neutral}&hide_border=true`;
  ...
  return (
    <Box  alignContent="center"display={isNonMobile ? "flex" : "block"} justifyContent="space-around" width="100%" height="100%" bgcolor={theme.palette.background.default}>
      {/* Sidebar and other components ... */}
      <img
  src={githubactivityStatsUrl}
